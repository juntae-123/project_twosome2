const FranchiseItem = () => {
  return (
    <div className="relative w-[100vw] h-full flex items-center justify-center">
      <div className="absolute top-[10%] left-[13vw]">
        <img
          className="w-[160px] h-[160px] max-md:w-[123px] max-md:h-[123px]"
          src="https://www.twosome.co.kr/resources/images/content/img_store_01@3x.png"
          alt=""
        />
      </div>
      <div className="absolute top-[30%] left-[30vw] max-md:w-[123px] max-md:h-[123px]">
        <img
          className="w-[160px] h-[160px] max-md:w-[123px] max-md:h-[123px]"
      ...
      <div className="absolute top-[70%] left-[60vw] max-md:w-[123px] max-md:h-[123px]">
        <img
          className="w-[160px] h-[160px] max-md:w-[123px] max-md:h-[123px]"
      ...
      <div className="absolute top-[20%] left-[90vw] max-md:w-[123px] max-md:h-[123px]">
        <img
          className="w-[160px] h-[160px] max-md:w-[123px] max-md:h-[123px]"
      ...
      <div className="absolute top-[60%] left-[120vw] max-md:w-[123px] max-md:h-[123px]">
        <img
          className="w-[160px] h-[160px] max-md:w-[123px] max-md:h-[123px]"
