    ...
    <section className="relative h-screen overflow-hidden bg-amber-100">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center">
        ...
        <div className="mt-6 flex gap-4">
          <button className="border border-black px-6 py-3 rounded-md font-bold hover:bg-gray-100">
            창업안내 바로가기 →
          </button>
          <button className="border border-black px-6 py-3 rounded-md font-bold hover:bg-gray-100">
            가맹상담 신청 →
